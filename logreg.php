    ...
    if ($query) {
        if ($query->num_rows > 0) {
            ...
            if ($pswd != $pswdVerify) {
                ...
                $insert = "INSERT INTO users (userName, email, pswd) VALUES ('$userName', '$email', '$hashedPassword')";
                if ($conn->query($insert)) {
                    $_SESSION["regSuccessMsg"] = 'Kayıt başarıyla gerçekleştirildi.';
                    header('location: logreg.php');
                }
                else {
                    echo "<script type=\"text/javascript\">"."alert('Kayıt başarısız oldu!');"."</script>";
                }
            }
        }
    }
    else {
        echo "<script type=\"text/javascript\">"."alert('Bağlantı hatası!');"."</script>";
    }
}
    ...
    if($query) {
        if ($query->num_rows > 0) {
            ...
            if (password_verify($pswd, $hashedPassword)) {
                ...
                $_SESSION['logSuccessMsg'] = "Giriş başarıyla gerçekleştirildi.";
...
<head>
    ...
    <meta name="author" content="ranexcdev">
    <title>Nandalf Movies</title>
...
<body>
    <main>
        <div id="header-scroll" class="row sticky ">
            <header class="header col-12">
                <div class="logo">
                    <a href="logreg.php"><img src="images/siteLogoR.png" alt="logo"></a>
                </div>
                        ...
                        <div class="dropdown">
                            ...
                            <div class="dropdown-content" id="y">
                                <div class="drpleft" id="yx">
                                    <a href="ReleaseYear/2000.html" class="drpa">2000</a>
                                    <a href="ReleaseYear/2001.html" class="drpa">2001</a>
                                    <a href="ReleaseYear/2002.html" class="drpa">2002</a>
                                    <a href="ReleaseYear/2003.html" class="drpa">2003</a>
                                    <a href="ReleaseYear/2004.html" class="drpa">2004</a>
                                    <a href="ReleaseYear/2005.html" class="drpa">2005</a>
                                    <a href="ReleaseYear/2006.html" class="drpa">2006</a>
                                    <a href="ReleaseYear/2007.html" class="drpa">2007</a>
                                    <a href="ReleaseYear/2008.html" class="drpa">2008</a>
                                    <a href="ReleaseYear/2009.html" class="drpa">2009</a>
                                </div>
                                <div class="drpright" id="yx">
                                    <a href="ReleaseYear/2010.html" class="drpa">2010</a>
                                    <a href="ReleaseYear/2011.html" class="drpa">2011</a>
                                    <a href="ReleaseYear/2012.html" class="drpa">2012</a>
                                    <a href="ReleaseYear/2013.html" class="drpa">2013</a>
                                    <a href="ReleaseYear/2014.html" class="drpa">2014</a>
                                    <a href="ReleaseYear/2015.html" class="drpa">2015</a>
                                    <a href="ReleaseYear/2016.html" class="drpa">2016</a>
                                    <a href="ReleaseYear/2017.html" class="drpa">2017</a>
                                    <a href="ReleaseYear/2018.html" class="drpa">2018</a>
                                    <a href="ReleaseYear/2019.html" class="drpa">2019</a>
                                </div>
                            </div>
                        </div>
                        <fieldset class="fields">
                ...
                <div class="userLog" id="userLog">
                    <button class="logreg" id="logbtn">GİRİŞ YAP</button>
                    <button class="logreg margin" id="regbtn">KAYIT OL</button>
                </div>
            </header> 
        </div>
        <div class="screens">
        ...
        <div class="mainContent" id="main" >
            <div class="wholeDiv" id="currentPage">
            ...
            <div class="movieContainer marginTop" id="searchResponse"></div>
        </div> 
        <footer class="footer row col-12" id="footer">
            <div class="footer-links">
                ...
                <ul id="socials" >
                    <li>
                        <a href="https://www.instagram.com/ranexcdev/" target="_blank"><i class="fab fa-instagram"></i> İnstagram</a>
                    </li>
                    <li>
            ...
            <div class="footer-about">
                <div class="about-text">
                    nandalfmovies 10.000 üzerinde film veya diziyi herhangi bir ücret ödemeden ya da hesap oluşturmadan online izleme imkanı sunan reklamsız ve ücretsiz bir film akış sitesidir.
                </div>
